...
export const ASSETS = {
  ...
  /** Homepage product visuals — replace files under public/images/memoora/products/ */
  leafMagnet: "/images/memoora/products/memoora-leaf-magnet.png",
  leafKeychain: "/images/memoora/products/memoora-leaf-keychain.png",
} as const;
